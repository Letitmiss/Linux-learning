...
### [8.3 磁盘的分割.格式化.检验与挂载](https://github.com/Letitmiss/Linux-learning/blob/master/blog/8.3disk_fileSystem.md)
### [8.4 设定开机挂载 ](https://github.com/Letitmiss/Linux-learning/blob/master/blog/8.4disk_fileSystem.md)
### [8.5 内存置换空间swap之建置](https://github.com/Letitmiss/Linux-learning/blob/master/blog/8.5disk_fileSystem.md)
### [8.6 文件系统的特殊观察与操作](https://github.com/Letitmiss/Linux-learning/blob/master/blog/8.6disk_fileSystem.md)
